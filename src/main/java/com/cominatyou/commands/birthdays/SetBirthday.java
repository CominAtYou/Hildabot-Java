...
public class SetBirthday {
    ...
    public static void set(MessageCreateEvent message, List<String> messageArgs) {
        ...
        if (birthdayStringExists) {
            message.getMessage().reply("You already have a birthday set! If you want to change it, please use `h!birthday edit month-day` or use </birthday edit:1011153003853643816>.");
            return;
        }
