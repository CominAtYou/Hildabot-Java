...
public class RankUtil {
    ...
    private final static int[] rankLevels = {1, 5, 10, 15}; // TODO: Undo when done
    ...
    // TODO: get the rest of the roles
    ...
    static {
        int i = 1;
        int index = 0;
        while (i <= 15) { // TODO: CHANGE THIS BACK TO 300 (actually 200 when not all the roles are in the array) and loop through the ranks array
