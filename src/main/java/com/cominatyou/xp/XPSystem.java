...
public class XPSystem {
    ...
    public static void giveXPForMessage(MessageCreateEvent message) {
        ...
        // Award XP.
        final int amount = ThreadLocalRandom.current().nextInt(2, 4 + 1) + (int) Math.ceil((double) currentLevel / 10); // random number between 2 and 4, inclusive, plus current level divided by 10, rounded up
